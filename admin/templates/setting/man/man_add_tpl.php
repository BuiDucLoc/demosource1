				...
				<div class="row">
					...
					<?php if(isset($config['setting']['slogan_title']) && $config['setting']['slogan_title'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							...
							<input type="text" class="form-control text-sm" name="data[options][slogan_title]" id="slogan_title" placeholder="slogan tiêu đề" value="<?=(!empty($flash->has('slogan_title'))) ? $flash->get('slogan_title') : @$options['slogan_title']?>">
						</div>
					<?php } ?>
					...
					<?php if(isset($config['setting']['coords']) && $config['setting']['coords'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="coords">Link Google Maps:</label>
							<input type="text" class="form-control text-sm" name="data[options][coords]" id="coords" placeholder="Link Google Maps" value="<?=(!empty($flash->has('coords'))) ? $flash->get('coords') : @$options['coords']?>">
						</div>
					<?php } ?>
